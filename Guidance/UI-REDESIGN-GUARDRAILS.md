...
> 目标：为 Memora 客户端做视觉层重设计，让界面更像便签学习工具，同时不改变既有功能逻辑、数据链路和用户流程。
...
- 浅色、温暖、纸张、便签、索引卡、学习桌面。
- 用材质感、细边线、轻微阴影、纸张错层制造吸引力。
- 避免暗黑系、避免营销站式大图、避免大面积单一紫蓝渐变。
- 详情页要明显区别于列表页，表现为进入“重点阅读区”。
- 系列化：列表卡片、详情面板、设置表单、统计卡片使用同一套纸张、墨色、胶带、标签语言。
